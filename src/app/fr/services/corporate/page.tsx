...
export const metadata: Metadata = {
  title: metaTranslations['services/corporate']['fr'].title,
  description: metaTranslations['services/corporate']['fr'].description,
  alternates: {
    canonical: 'https://helicro.be/fr/services/corporate',
    languages: {
...
export default function Page() {
  return <CorporateClient lang="fr" />;
}
