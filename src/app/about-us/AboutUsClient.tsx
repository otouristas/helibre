...
export default function AboutUsClient({ lang }: { lang: 'en' | 'nl' | 'fr' | 'el' }) {
  ...
  const ui = {
    en: {
      ...
      vSafety: 'Safety:',
      vSafetyDesc: 'Defensive, careful driving in high-spec Mercedes vehicles. Free booster and infant seats are prepared on request.',
      vTrans: 'Transparency:',
      vTransDesc: 'All price quotes are flat-rate. What we quote is exactly what you pay.',
      h2Vehicles: 'Our Vehicles',
      vehiclesDesc: 'We maintain a high-quality fleet of Mercedes-Benz Vito and V-Class minivans, fully air-conditioned and fitted with charging terminals. These vehicles are sanitized before every pickup and comfortably hold up to 8 passengers with generous luggage storage.',
    ...
    nl: {
      ...
      driverDesc: 'Uw chauffeur Gerasimos heeft ruim 30 jaar in het leger gediend, gespecialiseerd in defensieve logistiek en veiligheid. Na zijn overstap naar civiel personenvervoer bracht hij die discipline, routevoorbereiding en voertuigzorg over naar Helicro. U reist in onze Mercedes minivans met een ervaren professional.',
      h2Belgian: 'Een Belgische Service met een Grieks Hart',
      belgianDesc: 'Gerasimos is een Griekse expat die al decennia in België woont. Hierdoor bedienen we zowel internationale expats, diplomaten als Belgische bewoners optimaal. We spreken Engels, Frans, Grieks en Nederlands, wat alle stress rond communicatie wegneemt.',
      ...
      vSafety: 'Veiligheid:',
      vSafetyDesc: 'Defensieve rijstijl in luxe Mercedes wagens. Gratis kinderzitjes beschikbaar op aanvraag.',
      vTrans: 'Transparantie:',
      vTransDesc: 'Vaste prijzen. Wat we vooraf afspreken is wat u betaalt.',
      h2Vehicles: 'Onze Voertuigen',
      vehiclesDesc: 'Wij rijden met jonge Mercedes-Benz Vito en V-Klasse minivans, voorzien van airconditioning en oplaadpunten. Onze minivans bieden comfortabel plaats aan 8 passagiers en veel koffers.',
    ...
    fr: {
      ...
      belgianDesc: 'Gerasimos est un expatrié grec vivant en Belgique depuis des décennies. Ce double profil nous permet d\'accueillir chaleureusement la communauté internationale, les délégations diplomatiques et les résidents belges. Nous parlons français, anglais, grec et néerlandais.',
      ...
      vSafety: 'Sécurité :',
      vSafetyDesc: 'Conduite défensive en van Mercedes haut de gamme. Sièges enfants installés gratuitement.',
      vTrans: 'Transparence :',
      vTransDesc: 'Tarifs fixes convenus à l\'avance. Pas de mauvaise surprise.',
      h2Vehicles: 'Nos Véhicules',
      vehiclesDesc: 'Nous disposons de minivans Mercedes-Benz Vito et Classe V modernes, climatisés et équipés de ports USB. Nos véhicules sont désinfectés régulièrement et accueillent 8 passagers et leurs bagages.',
    ...
    el: {
      ...
      belgianDesc: 'Ο Γεράσιμος είναι Ελληνας ομογενής που ζει στο Βέλγιο εδώ και δεκαετίες. Αυτό μας επιτρέπει να εξυπηρετούμε την ελληνική κοινότητα, διπλωμάτες αλλά και ντόπιους κατοίκους. Παρέχουμε πλήρη υποστήριξη στα Ελληνικά, Αγγλικά, Γαλλικά και Ολλανδικά.',
      ...
      vSafety: 'Ασφάλεια:',
      vSafetyDesc: 'Αμυντική οδήγηση με Mercedes minivans. Δωρεάν παιδικά καθίσματα κατόπιν αιτήματος.',
      vTrans: 'Διαφάνεια:',
      vTransDesc: 'Σταθερές τιμές. Αυτό που συμφωνούμε είναι ακριβώς αυτό που πληρώνετε.',
      h2Vehicles: 'Τα Οχήματά μας',
      vehiclesDesc: 'Διαθέτουμε Mercedes-Benz Vito και V-Class minivans, πλήρως κλιματιζόμενα με θύρες φόρτισης. Καθαρίζονται σχολαστικά πριν από κάθε δρομολόγιο και χωρούν έως 8 επιβάτες με όλες τις αποσκευές τους.',
      ...
      <div className="container" style={{ maxWidth: '900px' }}>
        ...
        <div style={{ borderRadius: 'var(--radius-lg)', overflow: 'hidden', boxShadow: 'var(--shadow-lg)', marginBottom: '40px' }}>
          <img 
            ...
            alt="Helicro driver Gerasimos with Mercedes minivan" 
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '24px', marginBottom: '40px' }} className="grid-cols-mobile">
          <div style={{ borderRadius: 'var(--radius)', overflow: 'hidden', boxShadow: 'var(--shadow)' }}>
            <img src="/images/car-1.jpg" alt="Mercedes Vito" style={{ width: '100%', height: 'auto', display: 'block' }} />
          </div>
          <div style={{ borderRadius: 'var(--radius)', overflow: 'hidden', boxShadow: 'var(--shadow)' }}>
            <img src="/images/car-3.jpg" alt="Mercedes V-Class" style={{ width: '100%', height: 'auto', display: 'block' }} />
          </div>
        </div>
