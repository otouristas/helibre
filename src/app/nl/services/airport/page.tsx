...
export const metadata: Metadata = {
  title: metaTranslations['services/airport']['nl'].title,
  description: metaTranslations['services/airport']['nl'].description,
  alternates: {
    canonical: 'https://helicro.be/nl/services/airport',
    languages: {
