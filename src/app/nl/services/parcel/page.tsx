...
export const metadata: Metadata = {
  title: metaTranslations['services/parcel']['nl'].title,
  description: metaTranslations['services/parcel']['nl'].description,
  alternates: {
    canonical: 'https://helicro.be/nl/services/parcel',
    languages: {
