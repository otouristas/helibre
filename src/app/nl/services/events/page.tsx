...
export const metadata: Metadata = {
  title: metaTranslations['services/events']['nl'].title,
  description: metaTranslations['services/events']['nl'].description,
  alternates: {
    canonical: 'https://helicro.be/nl/services/events',
    languages: {
