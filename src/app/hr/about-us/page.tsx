...
export const metadata: Metadata = {
  title: metaTranslations['about-us']['hr'].title,
  description: metaTranslations['about-us']['hr'].description,
    alternates: {
    canonical: 'https://helicro.be/hr/about-us',
    languages: {
      ...
      'hr': 'https://helicro.be/hr/about-us',
    }
  }
};
