...
export const metadata: Metadata = pageMetadata({
  lang: 'en',
  title: 'Service Area | Private Driver Across Belgium | Helicro Transport',
  description:
    'Every Belgian city Helicro covers with a private English-speaking driver: Brussels, Antwerp, Ghent, Bruges, Leuven, Liège, Namur, Charleroi, Mons, Hasselt and Ostend. Fixed prices to all airports.',
  alternates: { en: '/en/service-area' },
});
