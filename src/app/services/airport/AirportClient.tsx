...
export default function AirportClient({ lang }: { lang: 'en' | 'nl' | 'fr' | 'el' }) {
  ...
  const ui = {
    en: {
      ...
      metaDesc: 'Pre-book a private Mercedes minivan transfer to Brussels Zaventem (BRU) or Charleroi (CRL). Vetted drivers, 24/7 dispatcher, child seats included.',
    ...
    nl: {
      ...
      metaDesc: 'Boek vooraf uw privé Mercedes minivan transfer naar luchthaven Zaventem (BRU) of Charleroi (CRL). Punctueel, 24/7 beschikbaar en gratis kinderzitjes.',
    ...
    fr: {
      ...
      metaDesc: 'Réservez à l\'avance votre transfert en monospace Mercedes vers Bruxelles-Zaventem ou Charleroi. Chauffeurs agréés, suivi de vol, sièges bébés inclus.',
    ...
    el: {
      ...
      metaDesc: 'Κάντε κράτηση για ιδιωτικό minivan Mercedes προς τα αεροδρόμια Zaventem (BRU) & Charleroi (CRL). Επαγγελματίες οδηγοί, live flight tracking.',
