...
export const blogArticles: BlogArticle[] = [
  ...
  {
    slug: 'charleroi-airport-to-brussels',
    lang: 'en',
    title: 'Charleroi Airport to Brussels: bus, train, taxi or private transfer compared (2026)',
    excerpt:
      'Brussels South Charleroi Airport is 60 km from the capital with no train station. Here is what each option really costs and takes, from the 17€ Flibco bus to a 25€ shared shuttle and a fixed-price private minivan.',
    date: 'September 22, 2026',
    datePublished: '2026-09-22',
    alternates: { en: '/en/blog/charleroi-airport-to-brussels', nl: '/nl/blog/van-charleroi-airport-naar-brussel' },
    readTime: '7 min read',
    category: 'Charleroi Transfers',
    ctaHref: '/en/airport-transfer/brussels-charleroi',
    ctaLabel: 'Book a fixed-price Charleroi Airport transfer →',
    image: '/images/airport-1.jpg',
    content: [
      'Brussels South Charleroi Airport (CRL) sits in Gosselies, 60 km south of Brussels, and it has no railway station. There are four realistic ways into the city: the Flibco shuttle bus to Brussels-Midi, a TEC bus plus train via Charleroi-Central, a metered taxi, or a pre-booked transfer. For one person with hand luggage the Flibco bus at about 17 to 20€ is the cheapest. For two or more people, families, late Ryanair arrivals or anyone staying away from Brussels-Midi, a Helicro shared shuttle at 25€ per person or a private minivan from 65€ per vehicle takes you door to door in 55 to 70 minutes.',
      '## Flibco bus: cheapest, but only to Brussels-Midi',
      'The Flibco coach leaves from the bus zone outside the terminal roughly every 20 to 30 minutes and takes about an hour to Brussels-Midi station in normal traffic. Online tickets cost around 17 to 20€ one way; walk-up fares are higher and the bus fills after each wave of arrivals. From Midi you still need a metro, tram or taxi to your hotel, with your suitcases, and after a late-night landing the queue can be long.',
      '## TEC bus and train via Charleroi-Central',
      'TEC bus A links the terminal with Charleroi-Central station in about 20 minutes; from there trains to Brussels-Midi take about 55 minutes and continue to Central and Nord. The combined ticket is cheaper than Flibco and the train runs late into the evening, but you change twice with luggage and the total is 90 minutes or more. Reasonable for a flexible solo traveller, poor for a family.',
      '## Taxi from the rank',
      'Official taxis wait outside arrivals. For the 60 km to Brussels the meter typically lands above 100€ and more at night, with the price only known at the end. It is the fallback when nothing is booked.',
      '## Shared shuttle: 25€ per person, door to door',
      'Helicro runs a shared minivan between Charleroi Airport and any address in Brussels for 25€ per person by day and 30€ at night. You share the van with a few passengers from the same arrival window, the driver waits inside the terminal with a Helicro sign, and everyone is dropped at their own door. Two people pay 50€, three pay 75€: close to the bus once you add the Midi connection, without the connection.',
      '## Private transfer: fixed price per vehicle',
      'A private Helicro minivan from Charleroi Airport to any Brussels address costs a fixed 65€ for 1 passenger, 75€ for 2, 90€ for 3, 110€ for 4 and up to 160€ for 8, at any hour, including luggage, child seats and 60 minutes of free waiting after landing. The driver tracks the flight, so a delayed Ryanair arrival at 23:50 costs the same as one at noon. For four people it is 27.50€ per head, door to door.',
      '## Cost and time by group size',
      '- 1 person, light luggage: Flibco (about 17 to 20€ plus 3 to 10€ to reach your hotel), 90 to 120 minutes door to door.',
      '- 1 person, late arrival or hotel far from Midi: shared shuttle 25€, about 75 to 90 minutes with the other pickups.',
      '- 2 people: shared shuttle 50€ or private 75€; both beat the bus plus taxi combination on comfort and often on price.',
      '- Family of 4 with child seats: private minivan 110€, seats included, about 60 minutes.',
      '- Group of 6 to 8: private minivan 130 to 160€, one vehicle for everyone and all the bags.',
      '## Where the Helicro driver waits at Charleroi',
      'Inside the terminal in the arrivals hall, holding a Helicro sign, or at the official Kiss & Ride zone in front of the building. Send your flight number when booking; the pickup time follows the real landing time automatically.',
      '## Going the other way',
      'From Brussels to Charleroi Airport the same prices apply. Plan the pickup so that you reach the terminal 2 hours before departure, and in the weekday morning rush allow up to 80 minutes for the E19.',
    ],
    faqs: [
      { question: 'How do I get from Charleroi Airport to Brussels city centre?', answer: 'Flibco bus to Brussels-Midi (about 17 to 20€, 60 minutes plus your onward trip), TEC bus A and train via Charleroi-Central (cheaper, 90 minutes or more), a metered taxi (usually over 100€), or a pre-booked Helicro transfer: 25€ per person shared or from 65€ per private minivan, door to door.' },
      { question: 'How far is Charleroi Airport from Brussels?', answer: 'About 60 km by the E19 and A54. A direct transfer takes 55 to 70 minutes outside peak hours and up to 80 minutes in the weekday morning rush.' },
      { question: 'Is there a train from Charleroi Airport to Brussels?', answer: 'Not from the airport itself. TEC bus A takes you to Charleroi-Central station in about 20 minutes, where trains to Brussels leave several times an hour.' },
      { question: 'How much is a taxi from Charleroi Airport to Brussels?', answer: 'A metered taxi usually costs more than 100€. A pre-booked Helicro private minivan is a fixed 65€ for 1 passenger, 75€ for 2, 110€ for 4 and 160€ for 8, or 25€ per person on the shared shuttle.' },
    ],
  },
  {
    slug: 'van-charleroi-airport-naar-brussel',
    lang: 'nl',
    title: 'Van Charleroi Airport naar Brussel: bus, trein, taxi of privétransfer vergeleken (2026)',
    excerpt:
      'Brussels South Charleroi Airport ligt 60 km van de hoofdstad en heeft geen treinstation. Dit kost en duurt elke optie echt: van de Flibco-bus aan 17€ tot een gedeelde shuttle aan 25€ en een privé minivan met vaste prijs.',
    date: '22 september 2026',
    datePublished: '2026-09-22',
    alternates: { en: '/en/blog/charleroi-airport-to-brussels', nl: '/nl/blog/van-charleroi-airport-naar-brussel' },
    readTime: '7 min lezen',
    category: 'Luchthavenvervoer',
    ctaHref: '/nl/luchthavenvervoer/charleroi',
    ctaLabel: 'Boek luchthavenvervoer Charleroi met vaste prijs →',
    image: '/images/airport-1.jpg',
    content: [
      'Brussels South Charleroi Airport (CRL) ligt in Gosselies, 60 km ten zuiden van Brussel, en heeft geen treinstation. Er zijn vier realistische manieren om de stad te bereiken: de Flibco-shuttlebus naar Brussel-Zuid, een TEC-bus plus trein via Charleroi-Centraal, een taxi met meter, of een vooraf geboekte transfer. Voor één persoon met handbagage is de Flibco-bus aan ongeveer 17 tot 20€ het goedkoopst. Voor twee of meer personen, gezinnen, late Ryanair-aankomsten of wie niet bij Brussel-Zuid logeert, brengt een gedeelde Helicro-shuttle aan 25€ per persoon of een privé minivan vanaf 65€ per voertuig u in 55 tot 70 minuten van deur tot deur.',
      '## Flibco-bus: het goedkoopst, maar enkel tot Brussel-Zuid',
      'De Flibco-bus vertrekt aan de buszone voor de terminal, ongeveer elke 20 tot 30 minuten, en doet er bij normaal verkeer zo’n uur over tot station Brussel-Zuid. Onlinetickets kosten ongeveer 17 tot 20€ enkele reis; aan het loket betaalt u meer en na elke golf aankomsten zit de bus vol. Vanaf Zuid hebt u nog een metro, tram of taxi nodig naar uw hotel, met uw koffers, en na een late landing kan de rij lang zijn.',
      '## TEC-bus en trein via Charleroi-Centraal',
      'TEC-bus A verbindt de terminal in ongeveer 20 minuten met station Charleroi-Centraal; vandaar doen treinen er zo’n 55 minuten over tot Brussel-Zuid en rijden door naar Centraal en Noord. Het gecombineerde ticket is goedkoper dan Flibco en de trein rijdt tot laat op de avond, maar u stapt twee keer over met bagage en het totaal is 90 minuten of meer. Prima voor een flexibele alleenreiziger, lastig voor een gezin.',
      '## Taxi aan de standplaats',
      'Officiële taxi’s wachten buiten aan de aankomsthal. Voor de 60 km naar Brussel komt de meter doorgaans boven de 100€ uit, ’s nachts meer, en u kent de prijs pas op het einde. Het is de noodoplossing als niets geboekt is.',
      '## Gedeelde shuttle: 25€ per persoon, van deur tot deur',
      'Helicro rijdt een gedeelde minivan tussen Charleroi Airport en elk adres in Brussel voor 25€ per persoon overdag en 30€ ’s nachts. U deelt de wagen met enkele passagiers uit hetzelfde aankomstvenster, de chauffeur wacht in de terminal met een Helicro-bordje en iedereen wordt aan zijn eigen deur afgezet. Twee personen betalen 50€, drie personen 75€: dicht bij de bus zodra u de verbinding vanaf Zuid meerekent, maar zonder die verbinding.',
      '## Privétransfer: vaste prijs per voertuig',
      'Een privé Helicro-minivan van Charleroi Airport naar elk Brussels adres kost een vaste 65€ voor 1 passagier, 75€ voor 2, 90€ voor 3, 110€ voor 4 en tot 160€ voor 8, op elk uur, inclusief bagage, kinderzitjes en 60 minuten gratis wachttijd na de landing. De chauffeur volgt de vlucht op, dus een vertraagde Ryanair-aankomst om 23u50 kost evenveel als een aankomst ’s middags. Voor vier personen is dat 27,50€ per hoofd, van deur tot deur.',
      '## Kosten en tijd per groepsgrootte',
      '- 1 persoon, lichte bagage: Flibco (ongeveer 17 tot 20€ plus 3 tot 10€ tot aan uw hotel), 90 tot 120 minuten van deur tot deur.',
      '- 1 persoon, late aankomst of hotel ver van Zuid: gedeelde shuttle 25€, ongeveer 75 tot 90 minuten met de andere ophalingen.',
      '- 2 personen: gedeelde shuttle 50€ of privé 75€; beide verslaan de combinatie bus plus taxi op comfort en vaak op prijs.',
      '- Gezin van 4 met kinderzitjes: privé minivan 110€, zitjes inbegrepen, ongeveer 60 minuten.',
      '- Groep van 6 tot 8: privé minivan 130 tot 160€, één voertuig voor iedereen en alle koffers.',
      '## Waar de Helicro-chauffeur wacht op Charleroi',
      'In de terminal in de aankomsthal, met een Helicro-bordje, of aan de officiële Kiss & Ride zone voor het gebouw. Geef uw vluchtnummer door bij het boeken; de ophaaltijd volgt automatisch de echte landingstijd.',
      '## In de andere richting',
      'Van Brussel naar Charleroi Airport gelden dezelfde prijzen. Plan de ophaling zo dat u 2 uur voor vertrek aan de terminal bent, en reken in de ochtendspits op weekdagen op maximaal 80 minuten voor de E19.',
    ],
    faqs: [
      { question: 'Hoe geraak ik van Charleroi Airport naar het centrum van Brussel?', answer: 'Met de Flibco-bus naar Brussel-Zuid (ongeveer 17 tot 20€, 60 minuten plus uw verdere traject), met TEC-bus A en de trein via Charleroi-Centraal (goedkoper, 90 minuten of meer), met een taxi met meter (meestal meer dan 100€), of met een vooraf geboekte Helicro-transfer: 25€ per persoon gedeeld of vanaf 65€ per privé minivan, van deur tot deur.' },
      { question: 'Hoe ver ligt Charleroi Airport van Brussel?', answer: 'Ongeveer 60 km via de E19 en A54. Een rechtstreekse transfer duurt 55 tot 70 minuten buiten de spits en tot 80 minuten in de ochtendspits op weekdagen.' },
      { question: 'Is er een trein van Charleroi Airport naar Brussel?', answer: 'Niet vanaf de luchthaven zelf. TEC-bus A brengt u in ongeveer 20 minuten naar station Charleroi-Centraal, waar meerdere keren per uur treinen naar Brussel vertrekken.' },
      { question: 'Wat kost een taxi van Charleroi Airport naar Brussel?', answer: 'Een taxi met meter kost meestal meer dan 100€. Een vooraf geboekte privé minivan van Helicro is een vaste 65€ voor 1 passagier, 75€ voor 2, 110€ voor 4 en 160€ voor 8, of 25€ per persoon met de gedeelde shuttle.' },
    ],
  },
  {
